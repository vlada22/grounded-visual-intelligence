...
| Measurement | Grounded SAM 2 | SAM 3 |
| --- | ---: | ---: |
| Zone A evidence interval | 0.00–3.75 s | 0.00–3.75 s |
| Zone A observed dwell | 4.00 s | 4.00 s |
| Zone B evidence interval | 4.00–9.75 s | 4.00–9.75 s |
...
![Line plot comparing mask IoU, bounding-box IoU, and mask centroid distance across 40 frames.](assets/03-cross-model-agreement.png)
